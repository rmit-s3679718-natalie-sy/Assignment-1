...
//			switch (option) {
//			case ADDUSER:
//				user = getUserDetails(kb);
//				boolean successful = userDatabase.add(user);
//				if (!successful)
//					System.out.println("The yard is full.");
//				break;
//			case FINDUSER:
//				System.out.println('\n' + "Find user with name:");
//				String findName = kb.getString();
//				index = userDatabase.indexOf(findName);
//				if (0 <= index) {
//					user = userDatabase.get(index);
//					printUserDetails(user);
//				} else
//					System.out.println("User:" + findName + "not found.");
//				break;
//
//			case LISTUSER:
//				listUsers();
...
//			printUserDetails(userDatabase.get(index));
//	}
//

//
//	public static void printUserDetails(User user) {
//		System.out.printf("%-8s %-17s %6d \n", user.getUserName(), user.getUserImage(), user.getUserStatus(),
//				user.getUserAge());
//	}
//
//	public static void main(String[] args) {
//		Driver driver = new Driver();
//		driver.initialiseUsers();
//		driver.runDriver();
//	}

	/*
	 * public int chooseTransaction() { System.out.println("\n    MiniNet Menu");
	 * System.out.println("\n    ========================================");
	 * String[] options = {"Add a person", "Select a person", "Exit"};
	 * 
	 * for (int i=0; i < options.length; i++) System.out.printf(" %3d : %s\n", i+1,
	 * options[i]);
	 * 
	 * int choice = 0; // while (choice < 1 || choice > options.length) // choice =
	 * validateChoiceInt("Enter Choice: ", 1, options.length); return choice; }
	 * 
	 * public static void main(String[] args) { Driver run = new Driver();
